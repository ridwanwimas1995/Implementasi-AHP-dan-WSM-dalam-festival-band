...
?>
<div class="post">
	<h2 class="title"><a href="#">Form Subkriteria Penampilan</a></h2>
...
<div align="center">
  <table width="800" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table table-condensed table-striped table-hover">
   <tbody>
    ...
    <?php 
	$sql = "SELECT * FROM tb_subkriteria_penampilan ORDER BY id_subkriteria Asc";
  ...
  <tr bgcolor="#FFFFFF"> 
	  ...
	  ?>
	    <td align="center"><a href="home.php?mod=subkriteria_penampilan&pg=form_kriteria">Ubah</a></td>
      <?php
	  }else{
	  ?>
		<td align="center"></td>
...
<div align="center" style="margin-top:20px">
 <table width="800" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table table-condensed table-striped table-hover">
   <tbody>
    ...
    <?php
	$sqlNilai = "SELECT * FROM tb_metrix_subkriteria_penampilan ORDER BY id_matrix Asc";
...
<div align="center" style="margin-top:20px">
 <table width="800" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table table-condensed table-striped table-hover">
   <tbody>
    ...
    <?php
	$sqlNilai = "SELECT * FROM tb_metrix_penjumlahan_penampilan ORDER BY id_matrix Asc";
	$resultNilai=mysql_query($sqlNilai) or die(mysql_error());
...
<div align="center" style="margin-top:20px">
 <table width="800" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table table-condensed table-striped table-hover">
   <tbody>
    ...
    <?php
	$sqlNilai = "SELECT * FROM tb_rasio_konsistensi_penampilan ORDER BY id_konsistensi Asc";
	$resultNilai=mysql_query($sqlNilai) or die(mysql_error());
	$xJumlah=0;
	//$n=0;
	while($rowsNilai=mysql_fetch_array($resultNilai)){
