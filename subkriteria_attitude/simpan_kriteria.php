...
$sqlBaik="Update tb_subkriteria_attitude set baik='$baik1',biasa='$baik2',buruk='$baik3' where id_subkriteria=1";
$resultBaik = mysql_query($sqlBaik) or die(mysql_error());

$sqlBiasa="Update tb_subkriteria_attitude set baik='$biasa1',biasa='$biasa2',buruk='$biasa3' where id_subkriteria=2";
$resultBiasa = mysql_query($sqlBiasa) or die(mysql_error());

$sqlBuruk="Update tb_subkriteria_attitude set baik='$buruk1',biasa='$buruk2',buruk='$buruk3' where id_subkriteria=3";
$resultBuruk = mysql_query($sqlBuruk) or die(mysql_error());


//ambil nilai
$sqlNilai="Select * from tb_subkriteria_attitude order by id_subkriteria Asc";
...
$sqlBaik="Update tb_metrix_subkriteria_attitude set baik='$NilaiBaik[0]',biasa='$NilaiBiasa[0]',buruk='$NilaiBuruk[0]',jumlah='$jumNilaiBaik',prioritas='$prioBaik',sub_prioritas='$subPrioBaik' where id_matrix=1";
$resultBaik = mysql_query($sqlBaik) or die(mysql_error());

$sqlBiasa="Update tb_metrix_subkriteria_attitude set baik='$NilaiBaik[1]',biasa='$NilaiBiasa[1]',buruk='$NilaiBuruk[1]', jumlah='$jumNilaiBiasa',prioritas='$prioBiasa',sub_prioritas='$subPrioBiasa' where id_matrix=2";
$resultBiasa = mysql_query($sqlBiasa) or die(mysql_error());

$sqlBuruk="Update tb_metrix_subkriteria_attitude set baik='$NilaiBaik[2]',biasa='$NilaiBiasa[2]',buruk='$NilaiBuruk[2]' ,jumlah='$jumNilaiBuruk',prioritas='$prioBuruk',sub_prioritas='$subPrioBuruk' where id_matrix=3";
$resultBuruk = mysql_query($sqlBuruk) or die(mysql_error());
...
$sqlBaik="Update tb_metrix_penjumlahan_attitude set baik='$hitMatrixBaik[1]',biasa='$hitMatrixBaik[2]',buruk='$hitMatrixBaik[3]', jumlah='$jumMatrixBaik' where id_matrix=1";
$resultBaik= mysql_query($sqlBaik) or die(mysql_error());

$sqlBiasa="Update tb_metrix_penjumlahan_attitude set baik='$hitMatrixBiasa[1]',biasa ='$hitMatrixBiasa[2]',buruk='$hitMatrixBiasa[3]', jumlah='$jumMatrixBiasa' where id_matrix=2";
$resultBiasa = mysql_query($sqlBiasa) or die(mysql_error());

$sqlBuruk="Update tb_metrix_penjumlahan_attitude set baik='$hitMatrixBuruk[1]',biasa='$hitMatrixBuruk[2]',buruk='$hitMatrixBuruk[3]',jumlah='$jumMatrixBuruk' where id_matrix=3";
$resultBuruk = mysql_query($sqlBuruk) or die(mysql_error());
...
if($CR<=0.1){
	header('location:../home.php?mod=subkriteria_attitude&pg=form_kriteria&status=2');
}else{
	
	//simpan ke tabel rasio konsistensi kriteria
$sqlBaik="Update tb_rasio_konsistensi_attitude set jumlah='$jumMatrixBaik',prioritas='$prioBaik', hasil='$rasioBaik' where id_konsistensi=1";
$resultBaik = mysql_query($sqlBaik) or die(mysql_error());

$sqlBiasa="Update tb_rasio_konsistensi_attitude set jumlah='$jumMatrixBiasa',prioritas='$prioBiasa', hasil='$rasioBiasa' where id_konsistensi=2";
$resultBiasa = mysql_query($sqlBiasa) or die(mysql_error());

$sqlBuruk="Update tb_rasio_konsistensi_attitude set jumlah='$jumMatrixBuruk',prioritas='$prioBuruk', hasil='$rasioBuruk' where id_konsistensi=3";
$resultBuruk = mysql_query($sqlBuruk) or die(mysql_error());
	...
	if($resultBaik) {
		header("location:../home.php?mod=subkriteria_attitude&pg=tampil_kriteria&status=0");
		
	} else {
		header('location:../home.php?mod=subkriteria_attitude&pg=tampil_kriteria&status=1');
	}
