...
?>
<div class="post">
	<h2 class="title"><a href="#">Keputusan Band Festival</a></h2>
...
<div align="center">
  <table width="800" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table table-condensed table-striped table-hover">
   <tbody>
    <tr> 
      <td colspan="7" bgcolor="#b9b7b7" align="center"><b>LIST DATA BAND</b></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
	...
	<td width="100" align="center"><b>Total Nilai</b></td>
  ...
  ?>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td><?php echo number_format($rows->total_nilai,4,",",".");?></td>
