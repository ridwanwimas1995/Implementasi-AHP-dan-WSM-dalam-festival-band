...
<div align="center">
  <table width="900" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table table-condensed table-striped table-hover">
   <tbody>
    <tr> 
      <td colspan="9" bgcolor="#b9b7b7" align="center"><b>LIST DATA BAND</b></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <?php 
	if($cari==""){
	$sql = "SELECT * FROM tb_band ORDER BY no_test Asc";
	}else{
  ...
  ?>
    <tr bgcolor="#FFFFFF"> 
	  ...
	  <td><?php echo $rows->album;?></td>
		...
		?>
    	 	<td align="center"> <a href='home.php?mod=band&pg=form_band&id=<?php echo $rows->no_test; ?>' target="_self">Ubah</a>
            | <a href='home.php?mod=band&pg=tampil_band&act=del&id=<?php echo $rows->no_test; ?>' onClick="return confirm('Yakin data akan dihapus?') " target="_self">Hapus</a></td>
            </td>
     	<?php
		}else{
		?>
  ...
  ?>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td>&nbsp;</td>
			...
			if ($_SESSION['hak']=='Panitia'){
			?>
      			<td align="center"><a href="home.php?mod=band&pg=form_band">Tambah</a></td> 
     		<?php
			}else{
			?>
				<td align="center"></td>
